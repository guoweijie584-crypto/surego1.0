    ...
    <view class="conversation__nav" :style="navStyle">
      <view class="conversation__nav-row" :style="navRowStyle">
        ...
        <view class="conversation__detail" @tap="goPartnerDetail(conversation.partnerPostId)">
          <text>查看搭子需求</text>
          <SuIcon name="arrowRight" size="32" glyph-size="16" variant="inline" color="#64748b" />
        </view>
      </view>
    </view>
...
.conversation__title { display: block; margin-top: 12rpx; color: #fff; font-size: 42rpx; font-weight: 900; line-height: 1.25; }
...
.conversation__panel-title { display: block; color: #111827; font-size: 29rpx; font-weight: 900; }
