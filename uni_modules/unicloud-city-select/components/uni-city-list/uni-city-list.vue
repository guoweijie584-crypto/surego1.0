<template>
	<view class="uni-city-list" ref="list" id="list" :style="'--top: '+top+'px'">
		<!-- #ifdef APP-NVUE -->
		...
		<!-- #endif -->
				<!-- #ifndef APP-NVUE -->
				<scroll-view :scroll-into-view="scrollViewId" class="uni-city-list__scroll" scroll-y>
